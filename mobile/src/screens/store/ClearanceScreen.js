...
export default function ClearanceScreen({ navigation, route }) {
  const title = route?.params?.title || "Clearance";
      ...
      <FlatList
        ...
        ListHeaderComponent={
          <Text style={styles.desc}>
            Selected styles from collections, now available at special prices. Explore
            cricket apparel and essentials in limited quantities, available while stocks
            last.
          </Text>
        }
